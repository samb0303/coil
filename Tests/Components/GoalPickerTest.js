...
import GoalPicker from '../../App/Components/GoalPicker'

const wrapper = shallow(<GoalPicker />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('GoalPicker Component')) // That the Component Text is included
})
